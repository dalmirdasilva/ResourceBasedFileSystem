...
#else
#define SROFS_SPEC_DRIVER SROFS_DRIVER_EXTERNAL_EEPROM
#endif

#ifndef srofs_spec_printf
#define srofs_spec_printf printf
#endif

#ifndef SROFS_SPEC_IGNORE_0
